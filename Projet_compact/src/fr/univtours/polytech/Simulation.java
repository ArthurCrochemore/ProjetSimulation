...
public class Simulation {
	...
	public Simulation(DonneeInitialisation data) throws Exception {
		...
		/*
		 * Creation de l'objet Deroulement qui gere le deroulement des evenements de la
		 * simulation
		 */
		deroulement = new Deroulement(this, heureDebutSimulation, heureFinSimulation, nbPatientsRDV + nbPatientsUrgent);
