...
public abstract class Evenement {
	 ...
	 * @param patient, patient concerne par l'evenement, null si aucun n'est concerne
	 * @param infirmier, infirmier concerne par l'evenement, null si aucun n'est concerne
	 * @param salle, salle concernee par l'evenement, null si aucun n'est concernee
	 * @param chirurgien, chirurgien concerne par l'evenement, null si aucun n'est concerne
	 * @param deroulement, objet deroulement qui contient l'evenement
	 */
	public Evenement(LocalTime heureDebut, Patient patient, Infirmier infirmier, Salle salle, Chirurgien chirurgien, Deroulement deroulement)
	{
