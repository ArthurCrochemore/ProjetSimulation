 ...
 * liberation vers les salles en attente de liberation.
 */
public class GIPrioriteLiberation implements GestionInfirmiers {
	private Simulation simulation;

	public GIPrioriteLiberation(Simulation simulation) {
		this.simulation = simulation;
	}

	public Salle solution() {

		if (simulation.getListes().getListesAttente().get(ListesAttentes.typeListes.LAIL).get(0) == null
				&& simulation.getListes().getListesAttente().get(ListesAttentes.typeListes.LAIP).get(0) != null) {
